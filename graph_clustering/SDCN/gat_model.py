...
class GAT(nn.Module):
    def __init__(self, num_features, hidden_size, hidden_size1, embedding_size, output_size, alpha):
        super(GAT, self).__init__()
        self.hidden_size = hidden_size
        self.embedding_size = embedding_size
        self.alpha = alpha
        self.conv1 = GATLayer(num_features, hidden_size, alpha)
        self.conv2 = GATLayer(hidden_size, hidden_size1, alpha)
        self.conv3 = GATLayer(hidden_size1, embedding_size, alpha)
        self.conv4 = GATLayer(embedding_size, output_size, alpha)
